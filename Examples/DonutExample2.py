...
from FunctionEncoder import GaussianDonutDataset2, DeterministicFunctionEncoder, TestDeterministicPerformanceCallback
...
if load_path is None:
    logdir = f"logs/donut_example2/{train_method}/{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}"
else:
    logdir = load_path
...
# create dataset
dataset = GaussianDonutDataset2(noise=0.1)
